      ...
      switch (P6.label) {
        case 0:
          if (o7 = i6.msit, s11 = i6.mstChallenge, u12 = i6.reconnectCount, a10 = void 0 === u12 ? 0 : u12, c14 = function() {
            ...
            return l13(w(e2, "Failed to connect")), [2];
          P6.label = 1;
        case 1:
        ...
        case 10:
          if (!(g10 = P6.sent()))
            return l13(w(e2, "Some error happened in the server")), [2];
...
function Pt(n6) {
  var r10 = n6.appData, i6 = n6.native, o7 = c5().liffId, s11 = M(), u12 = k(n6.url);
  if (!o7)
...
function Ne(e10) {
  ...
  De("--liff-base-background-color", h6), De("--liff-base-text-color", p12), De("--liff-base-background-rgb-color", d(h6)), De("--liff-base-text-rgb-color", d(p12)), De("--liff-light-button-border-color", v7), De("--liff-title-text-color", n6), De("--liff-title-background-color", a10), De("--liff-title-button-color", i6), De("--liff-icon-color", t2), De("--liff-status-bar-color", r10), De("--liff-title-subtext-color", o7), De("--liff-progress-bar-color", c14), De("--liff-progress-background-color", s11), De("--liff-title-button-area-background-color", s3(u12)), De("--liff-title-button-area-border-color", s3(d8));
}
function De(e10, t2) {
    ...
    return __generator(this, function(r10) {
      switch (r10.label) {
        ...
        case 2:
          ...
          }(e10.liffId, c14), Ve() && U3(c14)), h6 && R3(h6), d8 && A3(d8), f13 && F2(f13), v7 && C3(v7), window.addEventListener("pageshow", Ge), e3() ? [3, 5] : c14 && i6 ? [3, 5] : Ve() ? (g10 = E2(location.href, { "liff.hback": "2" }), _3({ redirectUri: g10 }), [4, new Promise(function() {
          })]) : [3, 4];
        case 3:
        ...
        case 6:
          if (b8 = r10.sent(), C6 = b8.client_id, F4 = b8.expires_in, I7 = m2(e10.liffId), C6 !== I7)
            throw _3(), w(I, "Failed to verify access_token");
      ...
      switch (r10.label) {
        ...
        case 2:
          if (t2.error && t2.liffOAuth2Error)
            throw a10 = t2.error, c14 = t2.error_description, l13 = c14.replace(/\+/g, " "), f13 = "".concat(a10, ": ").concat(l13), w(I, f13);
